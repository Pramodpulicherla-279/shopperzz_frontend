...
import { getDemandedProducts, getProducts, getCartProducts } from '../../api/services/product.service';
...
export const fetchDemandedProducts = createAsyncThunk('demandedProducts/fetchDemandedProducts', async () => {
...
export const fetchCartProducts = createAsyncThunk('cartProducts/fetchcartProducts', async () => {
